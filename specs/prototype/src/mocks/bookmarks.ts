...
export const initialBookmarks: Bookmark[] = [
  ...
  },
  {
    ...
    description: "Официальная документация Cloudflare",
    categoryId: "cat-docs",
  },
  {
    id: "bm-5",
    ...
    description: "Документация Hetzner Cloud",
    categoryId: "cat-docs",
  },
  {
    id: "bm-6",
    ...
    description: "Реестр контейнеров",
  ...
  },
  {
    ...
    description: "Редактор cron-выражений",
    categoryId: "cat-tools",
  },
  {
    id: "bm-9",
    ...
    description: "Туториалы по серверной инфраструктуре",
  ...
  },
  {
    ...
    description: "Единая документация по API",
    categoryId: "cat-resources",
  },
];
