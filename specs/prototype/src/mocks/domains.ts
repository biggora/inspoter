...
export const mockDnsRecords: Record<string, DnsRecord[]> = {
  "dom-01": [
    ...
    },
    {
      ...
      type: "TXT",
      name: "_dmarc",
      value: "v=DMARC1; p=quarantine; rua=mailto:dmarc@inspot.app",
      ttl: 3600,
    },
    {
      id: "dns-01-9",
