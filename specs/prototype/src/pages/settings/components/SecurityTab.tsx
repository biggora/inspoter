...
export function SecurityTab({ onNotify, disabled }: SecurityTabProps) {
  ...
  const inputClass =
    "w-full px-3 py-2.5 rounded-lg border border-background-200 bg-background-50 text-sm text-foreground-900 placeholder:text-foreground-400 focus:outline-none focus:ring-2 focus:ring-primary-300 focus:border-primary-300 transition-colors pr-10";
          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                >
                  <i
                    className={`${showCurrent ? "ri-eye-off-line" : "ri-eye-line"} text-sm`}
                  ></i>
                </button>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                >
                  <i
                    className={`${showNew ? "ri-eye-off-line" : "ri-eye-line"} text-sm`}
                  ></i>
                </button>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                >
                  <i
                    className={`${showConfirm ? "ri-eye-off-line" : "ri-eye-line"} text-sm`}
                  ></i>
                </button>
              </div>
            </div>
              ...
              >
                <div className="flex items-center gap-3">
                  <div className="w-9 h-9 rounded-lg bg-secondary-100 flex items-center justify-center shrink-0">
                    <i
                      className={`${session.current ? "ri-macbook-line" : "ri-smartphone-line"} text-sm text-secondary-600`}
                    ></i>
                  </div>
                  <div>
