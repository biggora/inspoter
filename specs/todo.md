...
[x] Добавить новый раздел в inspoter календарь +  события/напоминания.
[ ] добавить раздел мониторинг социальных сетей, получение комментариев сообщений и так далее [monitor-social](specs/monitor-social.md).
[x] Добавить новый раздел в инспоттер AI Assistant (аналог paperclip) — агенты, навыки, расписания, отчёты; см. docs/architecture.md §7I. Каталог MCP сейчас содержит 120 инструментов по 12 доменам и 20 скоупов; домены, активность, логи и серверы — только чтение. Отчёты: событие AGENT_RUN_COMPLETED и формат TELEGRAM_BOT поверх существующих Discord/INSPOT.
...
[x] добавить латышский язык
[ ] возможность удалять сообщения (webhook) в разделе messages
[ ] добавлять ссылки на панель администратора в сообщениях
...
в alerts, Infra vs Infrastructure в чем разница?
