...
const __ds_ns = (window.InspotDesignSystem_abeb6a = window.InspotDesignSystem_abeb6a || {});
...
function Badge({
  ...
  useCSS();
  const cls = ['insp-badge', `insp-badge--${tone}`, `insp-badge--${size}`, pulse ? 'insp-badge--pulse' : '', className].filter(Boolean).join(' ');
...
function Card({
  ...
  if (title) {
    return /*#__PURE__*/React.createElement(Comp, {
      onClick: onClick,
      className: ['insp-card', hover || clickable ? 'insp-card--hover' : '', clickable ? 'insp-card--clickable' : '', className].filter(Boolean).join(' ')
  ...
  return /*#__PURE__*/React.createElement(Comp, {
    onClick: onClick,
    className: ['insp-card', padCls, hover || clickable ? 'insp-card--hover' : '', clickable ? 'insp-card--clickable' : '', className].filter(Boolean).join(' ')
  }, children);
}
...
function StatCard({
  ...
  }, "/", sub)), subtitle && /*#__PURE__*/React.createElement("p", {
...
Object.assign(__ds_scope, { Dropdown, DropdownItem, DropdownSep, DropdownLabel });
...
function Button({
  ...
  useCSS();
  const cls = ['insp-btn', `insp-btn--${variant}`, `insp-btn--${size}`, block ? 'insp-btn--block' : '', className].filter(Boolean).join(' ');
  return /*#__PURE__*/React.createElement("button", _extends({
    className: cls,
...
function IconButton({
  ...
  useCSS();
  const cls = ['insp-iconbtn', `insp-iconbtn--${size}`, bordered ? 'insp-iconbtn--bordered' : '', className].filter(Boolean).join(' ');
  return /*#__PURE__*/React.createElement("button", _extends({
    className: cls
...
function Input({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    id: fieldId,
    className: ['insp-input', leadingIcon ? 'insp-input--has-lead' : '', trailingIcon ? 'insp-input--has-trail' : '', error ? 'insp-input--err' : ''].filter(Boolean).join(' ')
...
function Switch({
  ...
  if (!label && !description) return React.cloneElement(toggle, {
...
function WidgetLink({
  ...
  return /*#__PURE__*/React.createElement("button", {
    ...
    onMouseEnter: e => e.currentTarget.style.color = 'oklch(var(--foreground-700))',
    onMouseLeave: e => e.currentTarget.style.color = 'oklch(var(--foreground-400))'
...
function DashboardScreen({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "\u0414\u0430\u0448\u0431\u043E\u0440\u0434"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 12,
      color: 'oklch(var(--foreground-400))',
      margin: '4px 0 0'
    }
  }, "\u041E\u0431\u0437\u043E\u0440\u043D\u043E\u0435 \u0441\u043E\u0441\u0442\u043E\u044F\u043D\u0438\u0435 \u0432\u0441\u0435\u0439 \u0438\u043D\u0444\u0440\u0430\u0441\u0442\u0440\u0443\u043A\u0442\u0443\u0440\u044B Inspot")), /*#__PURE__*/React.createElement(Button, {
    variant: "ghost",
    size: "sm",
  ...
  }), online, " online")), /*#__PURE__*/React.createElement(StatCard, {
    icon: "ri-global-line",
    label: "\u0414\u043E\u043C\u0435\u043D\u044B",
    value: 3,
    sub: 4,
  ...
  }), "1 \u0438\u0441\u0442\u0435\u043A\u0430\u0435\u0442")), /*#__PURE__*/React.createElement(StatCard, {
    icon: "ri-alert-line",
    label: "\u041E\u043F\u043E\u0432\u0435\u0449\u0435\u043D\u0438\u044F",
    value: 4,
  ...
  }), "2 \u043A\u0440\u0438\u0442.")), /*#__PURE__*/React.createElement(StatCard, {
    icon: "ri-mail-line",
    label: "\u041F\u043E\u0447\u0442\u0430",
    value: 2,
    sub: 4,
    ...
    style: th
  }, "\u0421\u0435\u0440\u0432\u0435\u0440"), /*#__PURE__*/React.createElement("th", {
    style: th
  ...
  }, "RAM"))), /*#__PURE__*/React.createElement("tbody", null, D.servers.slice(0, 5).map(s => /*#__PURE__*/React.createElement("tr", {
    key: s.id
    ...
    style: td
  }, s.status === 'running' ? /*#__PURE__*/React.createElement(Badge, {
    tone: "accent",
    size: "sm",
    dot: true
  }, "\u041E\u043D\u043B\u0430\u0439\u043D") : /*#__PURE__*/React.createElement(Badge, {
    tone: "secondary",
    size: "sm",
    dot: true
  }, "\u041E\u0441\u0442\u0430\u043D\u043E\u0432\u043B\u0435\u043D")), /*#__PURE__*/React.createElement("td", {
    style: {
      ...td,
      textAlign: 'right',
      fontWeight: 500,
  ...
  }, s.status === 'running' ? s.cpuPct + '%' : '—'), /*#__PURE__*/React.createElement("td", {
    style: {
      ...td,
      textAlign: 'right',
      fontWeight: 500,
  ...
  }, s.status === 'running' ? s.ramPct + '%' : '—')))))), /*#__PURE__*/React.createElement(Card, {
    ...
    }, /*#__PURE__*/React.createElement("span", null, a.source), /*#__PURE__*/React.createElement("span", {
      style: {
        color: 'oklch(var(--foreground-400))'
      }
    }, a.ago), /*#__PURE__*/React.createElement("span", {
      style: {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      onMouseEnter: e => e.currentTarget.style.background = 'oklch(var(--background-100) / .5)',
    ...
    }, d.provider, " \xB7 ", d.registrar)), /*#__PURE__*/React.createElement(Badge, {
      tone: cfg.tone,
      size: "sm",
      dot: true
    }, d.label));
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/inspot/DashboardScreen.jsx", error: String((e && e.message) || e) }); }
...
function LoginScreen({
  ...
  }, "Inspot"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 14,
      color: 'oklch(var(--foreground-500))',
      margin: '4px 0 0'
    }
  }, "\u041F\u0430\u043D\u0435\u043B\u044C \u0443\u043F\u0440\u0430\u0432\u043B\u0435\u043D\u0438\u044F")), /*#__PURE__*/React.createElement("form", {
    onSubmit: e => {
      e.preventDefault();
      onLogin();
    },
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/inspot/LoginScreen.jsx", error: String((e && e.message) || e) }); }
...
function LogsScreen() {
  ...
  const filtered = D.logs.filter(l => (!level || l.level === level) && (!q || (l.message + l.source + l.service).toLowerCase().includes(q.toLowerCase())));
  const counts = {};
  filtered.forEach(l => {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    variant: "success"
  }, "\u0421\u043A\u043E\u043F\u0438\u0440\u043E\u0432\u0430\u043D\u043E \u0432 \u0431\u0443\u0444\u0435\u0440 \u043E\u0431\u043C\u0435\u043D\u0430"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      alignItems: 'center',
      gap: 12,
  ...
  }, filtered.length), " \u0437\u0430\u043F\u0438\u0441\u0435\u0439"), Object.keys(counts).map(lv => /*#__PURE__*/React.createElement(Badge, {
    key: lv,
    tone: D.levels[lv].tone,
    size: "sm"
  }, D.levels[lv].label, " ", counts[lv])), /*#__PURE__*/React.createElement("div", {
    style: {
      marginLeft: 'auto'
    }
  }, /*#__PURE__*/React.createElement(Button, {
    ...
    active: !level,
    onClick: () => setLevel('')
  }, "\u0412\u0441\u0435 \u0443\u0440\u043E\u0432\u043D\u0438"), Object.keys(D.levels).map(lv => /*#__PURE__*/React.createElement(DropdownItem, {
    key: lv,
    icon: D.levels[lv].icon,
    active: level === lv,
    onClick: () => setLevel(lv)
  }, D.levels[lv].label)))), /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, "\u0423\u0440\u043E\u0432\u0435\u043D\u044C"), /*#__PURE__*/React.createElement("th", {
    style: {
      ...th,
      width: 130
    }
  }, "\u0418\u0441\u0442\u043E\u0447\u043D\u0438\u043A"), /*#__PURE__*/React.createElement("th", {
    style: th
  }, "\u0421\u043E\u043E\u0431\u0449\u0435\u043D\u0438\u0435"), /*#__PURE__*/React.createElement("th", {
    style: {
      ...th,
      width: 44
    }
  }))), /*#__PURE__*/React.createElement("tbody", null, filtered.map(l => {
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, {
      ...
      style: {
        ...
        background: open ? 'oklch(var(--background-100) / .5)' : 'transparent',
        cursor: 'pointer'
      },
    ...
    }, l.ts), /*#__PURE__*/React.createElement("td", {
      style: {
        padding: '12px 16px'
      }
      ...
      size: "sm",
      icon: lv.icon
    }, lv.label)), /*#__PURE__*/React.createElement("td", {
      style: {
        padding: '12px 16px',
        fontSize: 12,
        fontWeight: 500,
    ...
    }, l.source, /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 10,
        color: 'oklch(var(--foreground-400))',
        textTransform: 'uppercase'
      }
    }, l.service)), /*#__PURE__*/React.createElement("td", {
      style: {
        padding: '12px 16px',
        fontSize: 13,
    ...
    }, l.details)), /*#__PURE__*/React.createElement("div", {
      style: {
        marginTop: 10
      }
    }, /*#__PURE__*/React.createElement(Button, {
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/inspot/LogsScreen.jsx", error: String((e && e.message) || e) }); }
...
function ServerCard({
  ...
  }, s.ip))), running ? /*#__PURE__*/React.createElement(Badge, {
    tone: "accent",
    dot: true
  }, "Running") : /*#__PURE__*/React.createElement(Badge, {
    tone: "secondary",
    dot: true
  }, "Stopped")), /*#__PURE__*/React.createElement("div", {
    style: {
      padding: '12px 16px',
      display: 'flex',
      flexDirection: 'column',
  ...
  }, row('CPU', s.cpu), row('RAM', s.ram), row('Disk', s.disk), row('OS', s.os), row('Location', s.location)), /*#__PURE__*/React.createElement("div", {
    style: {
      padding: '12px 16px',
      borderTop: '1px solid oklch(var(--background-100))',
      display: 'flex',
  ...
  }, running ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Button, {
    variant: "secondary",
    size: "sm",
...
function ServersScreen() {
  ...
  }, D.servers.length, " \u0441\u0435\u0440\u0432\u0435\u0440\u043E\u0432 \xB7 Hetzner"), /*#__PURE__*/React.createElement(Button, {
    variant: "ghost",
    size: "sm",
    icon: "ri-refresh-line"
  }, "\u041E\u0431\u043D\u043E\u0432\u0438\u0442\u044C")), /*#__PURE__*/React.createElement("div", {
  ...
  }, D.servers.map(s => /*#__PURE__*/React.createElement(ServerCard, {
    key: s.id,
    s: s,
    onAction: (server, action) => setPending({
      server,
      action
    })
  ...
  }, pending && `Сервер «${pending.server.name}» будет ${{
    start: 'запущен',
    stop: 'остановлен',
    restart: 'перезагружен'
  }[pending.action]}. Возможна кратковременная недоступность сервисов.`));
}
window.ServersScreen = ServersScreen;
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/inspot/ServersScreen.jsx", error: String((e && e.message) || e) }); }
...
function SettingsScreen({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    variant: "success"
  }, "\u041D\u0430\u0441\u0442\u0440\u043E\u0439\u043A\u0438 \u043E\u0444\u043E\u0440\u043C\u043B\u0435\u043D\u0438\u044F \u0441\u043E\u0445\u0440\u0430\u043D\u0435\u043D\u044B"), /*#__PURE__*/React.createElement("div", {
    style: {
      marginBottom: 28
    }
    ...
    onChange: setTab,
    options: tabs
  })), tab === 'appearance' && /*#__PURE__*/React.createElement("div", {
    style: {
      maxWidth: 640,
      display: 'flex',
      flexDirection: 'column',
  ...
  }, "\u0422\u0435\u043C\u0430 \u043E\u0444\u043E\u0440\u043C\u043B\u0435\u043D\u0438\u044F"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
      gridTemplateColumns: 'repeat(3, 1fr)',
      gap: 12
    }
  }, themeCard('system', 'Системная', 'По настройкам ОС', 'ri-contrast-2-line'), themeCard('light', 'Светлая', 'Всегда светлая тема', 'ri-sun-line'), themeCard('dark', 'Тёмная', 'Всегда тёмная тема', 'ri-moon-line'))), /*#__PURE__*/React.createElement(Card, {
    padding: "md"
  }, /*#__PURE__*/React.createElement("h4", {
    style: {
      fontFamily: 'var(--font-heading)',
  ...
  }, "\u0418\u043D\u0442\u0435\u0440\u0444\u0435\u0439\u0441"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: 4
    }
  }, [['Компактный режим', 'Уменьшенные отступы и размеры', compact, setCompact], ['Метки времени', 'Показывать относительное время', timestamps, setTimestamps], ['Моноширинные шрифты', 'Мон-шрифт в логах и деталях', mono, setMono]].map(([t, d, v, set]) => /*#__PURE__*/React.createElement("div", {
    key: t,
    style: {
      padding: '10px 12px',
      borderRadius: 'var(--radius-lg)'
  ...
  }), autoRefresh && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 16,
      paddingTop: 16,
      borderTop: '1px solid oklch(var(--background-100))'
  ...
  }, "\u0418\u043D\u0442\u0435\u0440\u0432\u0430\u043B \u043E\u0431\u043D\u043E\u0432\u043B\u0435\u043D\u0438\u044F"), /*#__PURE__*/React.createElement(SegmentedControl, {
    variant: "pill",
    value: interval,
  ...
  }, "\u0421\u043E\u0445\u0440\u0430\u043D\u0438\u0442\u044C \u0438\u0437\u043C\u0435\u043D\u0435\u043D\u0438\u044F"))), tab === 'profile' && /*#__PURE__*/React.createElement("div", {
    style: {
      maxWidth: 520,
      display: 'flex',
      flexDirection: 'column',
  ...
  }, "\u041E\u043F\u0435\u0440\u0430\u0442\u043E\u0440 \xB7 admin@inspot.app"))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: 14
    ...
    icon: "ri-check-line",
    onClick: () => setToast(true)
  }, "\u0421\u043E\u0445\u0440\u0430\u043D\u0438\u0442\u044C"))), (tab === 'notifications' || tab === 'security') && /*#__PURE__*/React.createElement("div", {
    style: {
      maxWidth: 520
    }
  }, /*#__PURE__*/React.createElement(Card, {
    ...
    label: tab === 'security' ? 'Двухфакторная аутентификация' : 'Email-уведомления',
    description: tab === 'security' ? 'Требовать код при входе' : 'Присылать оповещения на почту',
    checked: true,
    onChange: () => {}
  }), /*#__PURE__*/React.createElement(Switch, {
    label: tab === 'security' ? 'Сессии на всех устройствах' : 'Критические оповещения',
    description: tab === 'security' ? 'Выходить со всех сессий при смене пароля' : 'Мгновенные push при сбоях',
    checked: false,
    onChange: () => {}
  })))));
}
window.SettingsScreen = SettingsScreen;
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/inspot/SettingsScreen.jsx", error: String((e && e.message) || e) }); }
...
function Shell({
  ...
  const navItem = item => {
    ...
    return /*#__PURE__*/React.createElement("button", {
      ...
      style: {
        ...
        color: active ? 'oklch(var(--primary-700))' : 'oklch(var(--foreground-600))',
    ...
    }), !collapsed && /*#__PURE__*/React.createElement("span", null, item.label), !collapsed && item.path === 'alerts' && unackCount > 0 && /*#__PURE__*/React.createElement("span", {
      style: {
        marginLeft: 'auto',
        fontSize: 10,
        fontWeight: 600,
  ...
  }, "Inspot")), /*#__PURE__*/React.createElement("nav", {
    style: {
      flex: 1,
      overflowY: 'auto',
      padding: 12,
  ...
  }, D.nav.map(navItem)), /*#__PURE__*/React.createElement("div", {
    style: {
      padding: 12,
  ...
  }, TITLES[current])), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      alignItems: 'center',
      gap: 4
  ...
  }, /*#__PURE__*/React.createElement(DropdownLabel, null, "admin \xB7 \u041E\u043F\u0435\u0440\u0430\u0442\u043E\u0440"), /*#__PURE__*/React.createElement(DropdownItem, {
    icon: "ri-user-line",
    onClick: () => onNavigate('settings')
  }, "\u041F\u0440\u043E\u0444\u0438\u043B\u044C"), /*#__PURE__*/React.createElement(DropdownItem, {
    icon: "ri-settings-4-line",
    onClick: () => onNavigate('settings')
  }, "\u041D\u0430\u0441\u0442\u0440\u043E\u0439\u043A\u0438"), /*#__PURE__*/React.createElement(DropdownSep, null), /*#__PURE__*/React.createElement(DropdownItem, {
...
window.Shell = Shell;
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/inspot/Shell.jsx", error: String((e && e.message) || e) }); }
...
window.INSPOT_DATA = {
  ...
  logs: [{
    ...
    details: 'PID: 31245 | Current connections: 200/200 | Client: 10.0.1.45 | Application: api-gateway'
  }, {
    id: 'l3',
    ts: '10:21:00',
    level: 'warn',
    ...
    details: 'Used: 5153960755 bytes | Max: 6442450944 bytes | Eviction: allkeys-lru | Fragmentation: 1.12'
  }, {
    id: 'l4',
    ts: '10:20:30',
    level: 'info',
    ...
    details: 'Zone: inspot.app | IP: 91.234.56.78 | Action: BLOCK | Country: RU'
  }, {
    id: 'l5',
    ts: '10:19:45',
    level: 'info',
    ...
    source: 'web-prod-01',
    service: 'nginx',
    message: 'client sent invalid Host header while reading client request',
    ...
    details: 'Primary LSN: 3A/9F0012 | Replica LSN: 3A/9C0044 | Lag: 47s'
  }],
  levels: {
    debug: {
      label: 'DEBUG',
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/inspot/data.js", error: String((e && e.message) || e) }); }
