...
function LogsScreen() {
  ...
  return (
    <div style={{ padding: 24 }}>
      ...
      >
        <span style={{ fontSize: 12, color: "oklch(var(--foreground-500))" }}>
          <b style={{ color: "oklch(var(--foreground-700))" }}>
            {filtered.length}
          </b>{" "}
          записей
        </span>
        {Object.keys(counts).map((lv) => (
          <Badge key={lv} tone={D.levels[lv].tone} size="sm">
            {D.levels[lv].label} {counts[lv]}
          </Badge>
        ))}
      ...
      >
        ...
        >
          <DropdownItem active={!level} onClick={() => setLevel("")}>
            Все уровни
          </DropdownItem>
      ...
      >
        <table style={{ width: "100%", borderCollapse: "collapse" }}>
          <thead>
            <tr>
              <th style={{ ...th, width: 90 }}>Время</th>
              <th style={{ ...th, width: 100 }}>Уровень</th>
              <th style={{ ...th, width: 130 }}>Источник</th>
                ...
                <React.Fragment key={l.id}>
                  ...
                  >
                    ...
                    <td style={{ padding: "12px 16px" }}>
                      <Badge tone={lv.tone} size="sm" icon={lv.icon}>
                        {lv.label}
                      </Badge>
                    </td>
                    <td
