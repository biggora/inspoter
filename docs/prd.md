...
All IDs are stable and must not be renumbered, reused, or transferred. v3.20 has exactly **220 unconditional active criteria + 16 conditionally applicable AC-REAL criteria + 1 inactive criterion = 237 unique criteria** (v3.19's 229 plus AC-AGT-001..008):
