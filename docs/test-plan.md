...
- **Icon URL rendering / broken-image edge cases beyond the "no icon" fallback:** a malformed *icon URL that is set* isn't specified by any AC and isn't tested.
