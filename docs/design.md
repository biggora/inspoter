...
**Version:** v2.4
**Status:** Draft Bookmarks nested-category-groups amendment (AC-BM-029..034) — independent doc-review pending; v2.5/v2.4/v2.3/v2.2 amendments otherwise unaffected
**Owner:** UI/UX Designer
**Date:** 2026-07-15
**Source of truth for:** frontend implementor and test engineer
**Consumes:** docs/prd.md v3.4 (Bookmarks drag-and-drop reordering amendment), docs/architecture.md v1.4, and all three Q-3 inputs: specs/prototype/, specs/inspot-design/, specs/ui.md
...
### v2.6 — 2026-07-15 (Bookmarks nested category groups amendment, Phase 4)
...
### v2.5 — 2026-07-15 (Bookmarks favicon-suggest amendment, Phase 3)
...
### v2.4 — 2026-07-15 (Bookmarks drag-and-drop reordering amendment)
...
### v2.3 — 2026-07-15 (Bookmarks search/filter amendment)
...
### v2.2 — 2026-07-15 (Bookmarks accent-color amendment)
