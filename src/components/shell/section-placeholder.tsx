...
export function SectionPlaceholder({ section, description, icon: Icon }: SectionPlaceholderProps) {
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-col items-center justify-center gap-3 rounded-lg border border-border bg-card px-6 py-24 text-center">
        ...
        <h2 className="text-lg font-semibold text-foreground">{section} — coming soon</h2>
