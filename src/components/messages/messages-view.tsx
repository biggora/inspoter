  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <div className="flex-1 space-y-0.5 overflow-y-auto px-2 py-2">
        {categories.length === 0 ? (
          <p className="px-2 py-4 text-xs text-foreground-400">
            Категорий пока нет.
          </p>
        ) : (
                ...
                {!isCollapsed && (
                  <div className="flex flex-col gap-0.5">
                    {category.channels.length === 0 ? (
                      <p className="px-3 py-1 text-xs text-foreground-400">
                        Нет каналов
                      </p>
                    ) : (
  ...
  if (categoriesError) {
    return (
      <div className="-m-6 flex h-[calc(100vh-3.5rem)] items-center justify-center p-6">
        <div className="max-w-sm animate-in fade-in-0 zoom-in-95 text-center duration-200">
          <div className="mx-auto mb-5 flex h-16 w-16 items-center justify-center rounded-2xl bg-primary-100">
            <i className="ri-message-3-line text-2xl text-primary-600" aria-hidden />
          </div>
          <h3 className="mb-2 font-heading text-lg font-semibold text-foreground-900">
            Не удалось загрузить сообщения
          </h3>
          <p className="mb-6 text-sm text-foreground-500">{categoriesError}</p>
        ...
        <div className="flex min-w-0 flex-1 flex-col bg-background-50">
          {!selectedChannel ? (
            <div className="flex h-full items-center justify-center p-8">
              <div className="animate-in fade-in-0 zoom-in-95 text-center duration-200">
                <div className="mx-auto mb-5 flex h-16 w-16 items-center justify-center rounded-2xl bg-secondary-100">
                  <i
                    className="ri-message-2-line text-2xl text-secondary-500"
                    aria-hidden
                  />
                </div>
                <h3 className="mb-1 font-heading text-base font-semibold text-foreground-900">
                  {categories.length === 0
                    ? "Категорий пока нет"
                    : "Выберите канал"}
                </h3>
                <p className="max-w-xs text-sm text-foreground-400">
                  {categories.length === 0
              ...
              <div className="flex-1 overflow-y-auto px-5 py-4">
                {messagesError ? (
                  <div className="flex h-full items-center justify-center">
                    <div className="animate-in fade-in-0 zoom-in-95 max-w-sm text-center duration-200">
                      <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-primary-100">
                        <i
                          className="ri-message-3-line text-xl text-primary-600"
                          aria-hidden
                        />
                      </div>
                      <h4 className="mb-1 font-heading text-sm font-semibold text-foreground-900">
                        Не удалось загрузить сообщения
                      </h4>
                  ...
                  <div className="flex h-full items-center justify-center">
                    <div className="animate-in fade-in-0 zoom-in-95 text-center duration-200">
                      <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-secondary-100">
                        <i
                          className="ri-message-2-line text-xl text-secondary-600"
                          aria-hidden
                        />
                      </div>
                      <h4 className="mb-1 font-heading text-sm font-semibold text-foreground-900">
