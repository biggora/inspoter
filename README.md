...
| `AGENT_*`                                                                                      | необязательны                  | Потолки и очередь ИИ-ассистента: шаги, токены, время, лизы, размер пачки, параллелизм и ретеншн истории. Полный список с умолчаниями — в `.env.example`.                                    |
...
запуски старше `AGENT_RUN_RETENTION_DAYS` вместе со своими шагами. Запуски в
